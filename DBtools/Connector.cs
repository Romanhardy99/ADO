...
namespace DBtools
{
    public class Connector
    {
        ...
        public void Select(string cmd)
        {
            ...
            reader.Close();
            //Заново выполдняем запрос  и выводим результаты запроса:
        ...
        {
            //@"RAW - строка, она игнорирует Escape-последовательности, символы переноса и другие спец-символы"
...
AND		CONSTRAINT_TYPE=N'PRIMARY KEY'
        ...
        public void Update(string table, string fields, string values,  string condition)
        {
            ...
            {
                parsed += $"{s_fields[i]}={ParseValue(s_fields[i])}";
